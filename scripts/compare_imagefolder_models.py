...
MODEL_SEED_OFFSETS = {
    ...
    "delayed_xattnres_no_prefill": 45_000,
    "xattnres_equal_params": 50_000,
    "prefill_local_mix": 60_000,
    "no_prefill_local_mix": 70_000,
    "fpn_sum_lite": 72_000,
    "fpn_concat_lite": 74_000,
    "region_pool_mixer_no_history": 76_000,
    "stage_refresh_region_slots_2x2": 78_000,
...
def build_model(
    ...
    builders = {
        ...
        "delayed_xattnres_no_prefill": lambda: TinyDelayedXAttnResClassifier(
            embed_dim=embed_dim,
            num_classes=num_classes,
        ),
        ...
        "fpn_sum_lite": lambda: TinyFPNLiteClassifier(
            embed_dim=embed_dim,
            num_classes=num_classes,
            fuse_mode="sum",
        ),
        "fpn_concat_lite": lambda: TinyFPNLiteClassifier(
            embed_dim=embed_dim,
            num_classes=num_classes,
            fuse_mode="concat",
        ),
        "region_pool_mixer_no_history": lambda: TinyRegionPoolMixerClassifier(
            embed_dim=embed_dim,
            num_classes=num_classes,
        ),
        "stage_refresh_region_slots_2x2": lambda: TinyStageRefreshRegionSlotsClassifier(
            embed_dim=embed_dim,
            num_classes=num_classes,
        ),
