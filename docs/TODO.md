...
- Long-train Small detector-side class head now becomes the strongest RF-DETR route. The resumed Small 384px seed41 run improves with longer training: 5ep -> 8ep -> 12ep -> 16ep class AP50 is `0.2405 -> 0.2677 -> 0.3070 -> 0.3209`, AP75 is `0.1795 -> 0.2053 -> 0.2155 -> 0.2268`, offcenter AP50 is `0.2238 -> 0.2260 -> 0.2955 -> 0.2881`, small AP50 is `0.2457 -> 0.2594 -> 0.2911 -> 0.3258`, and class-agnostic AP50 remains high at `0.6374` for 16ep. The second direct Small seed43 run also improves consistently through 12ep: 5ep -> 8ep -> 12ep class AP50 is `0.1762 -> 0.2066 -> 0.2923`, AP75 is `0.1318 -> 0.1491 -> 0.1802`, offcenter AP50 is `0.1506 -> 0.1795 -> 0.2562`, small AP50 is `0.1220 -> 0.1697 -> 0.2921`, and large AP50 is `0.3263 -> 0.3973 -> 0.4235`; class-agnostic AP50 remains high at `0.6290` for 12ep. Direct Small 12ep two-seed mean class AP50 is about `0.2997`, and seed41 16ep now reaches `0.3209`, making direct Small long training the strongest current RF-DETR route and clearly above staged pseudo-pretrain. RF-DETR internal validation metrics after resume can be misleadingly high or non-monotonic; official conclusions use independent `predict_rfdetr_coco.py` export from `checkpoint_best_regular.pth`.
