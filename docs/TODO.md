...
- Long-train Small detector-side class head now becomes the strongest RF-DETR route. The resumed Small 384px 5ep regular checkpoint reaches independent-test class AP50 `0.2405`, AP75 `0.1795`, class-agnostic AP50 `0.6352`, offcenter AP50 `0.2238`, small AP50 `0.2457`, and large AP50 `0.3768`, substantially above the previous Nano GT-only / staged-pseudo 4ep range around AP50 `0.150-0.162`. This supersedes more self-teacher pseudo-label repeats as the next active direction: prioritize a formal longer Small/Nano detector-side protocol and only return to pseudo-labeling if a train-split teacher also beats Nano5 after filtering.
