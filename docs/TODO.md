...
- Long-train Small detector-side class head now becomes the strongest RF-DETR route. The resumed Small 384px seed41 5ep regular checkpoint reaches independent-test class AP50 `0.2405`, AP75 `0.1795`, class-agnostic AP50 `0.6352`, offcenter AP50 `0.2238`, small AP50 `0.2457`, and large AP50 `0.3768`; extending seed41 to the resumed 8ep run improves class AP50 further to `0.2677`, AP75 `0.2053`, center AP50 `0.2527`, and small AP50 `0.2594`. A second direct Small seed43 run improves consistently with longer training: 5ep -> 8ep -> 12ep class AP50 is `0.1762 -> 0.2066 -> 0.2923`, AP75 is `0.1318 -> 0.1491 -> 0.1802`, offcenter AP50 is `0.1506 -> 0.1795 -> 0.2562`, small AP50 is `0.1220 -> 0.1697 -> 0.2921`, and large AP50 is `0.3263 -> 0.3973 -> 0.4235`; class-agnostic AP50 remains high at `0.6290` for 12ep. Direct Small 12ep seed43 is now the strongest single checkpoint, and direct Small training clearly beats staged pseudo-pretrain. Next fair protocol step is seed41 8ep -> 12ep to form an equal-budget direct-Small two-seed result. Small-resume8 remains the checked train-split teacher gate, but staged pseudo-pretrain is only a warm-start diagnostic. Avoid raw GT+pseudo concatenation.
