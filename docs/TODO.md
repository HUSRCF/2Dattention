...
- Long-train Small detector-side class head now becomes the strongest RF-DETR route. The resumed Small 384px seed41 run improves with longer training: 5ep -> 8ep -> 12ep class AP50 is `0.2405 -> 0.2677 -> 0.3070`, AP75 is `0.1795 -> 0.2053 -> 0.2155`, offcenter AP50 is `0.2238 -> 0.2260 -> 0.2955`, small AP50 is `0.2457 -> 0.2594 -> 0.2911`, and class-agnostic AP50 stays high at `0.6397` for 12ep. The second direct Small seed43 run also improves consistently: 5ep -> 8ep -> 12ep class AP50 is `0.1762 -> 0.2066 -> 0.2923`, AP75 is `0.1318 -> 0.1491 -> 0.1802`, offcenter AP50 is `0.1506 -> 0.1795 -> 0.2562`, small AP50 is `0.1220 -> 0.1697 -> 0.2921`, and large AP50 is `0.3263 -> 0.3973 -> 0.4235`; class-agnostic AP50 remains high at `0.6290` for 12ep. Direct Small 12ep two-seed mean class AP50 is now about `0.2997`, making it the strongest current RF-DETR route and clearly above staged pseudo-pretrain. Small-resume8 remains the checked train-split teacher gate, but staged pseudo-pretrain is only a warm-start diagnostic. Avoid raw GT+pseudo concatenation.
